			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					...
					<c:if test="${sessionScope.account == null}">
						...
						<li><a href="/LaptrinhData/register">Register</a></li>
					</c:if>
					<c:if test="${sessionScope.account != null}">
								<li><a>${sessionScope.account.fullname}</a></li>
								<li><a href="/LaptrinhData/logout">Log Out</a></li>
					</c:if>
				</ul>
			</div>
			<!-- END TOP BAR MENU -->
				...
				<div class="content-form-page">
					<div class="row">
						<div class="col-md-7 col-sm-7">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="fullname"
										name="fullname" value="${fullname}" readonly>
								</div>
							</div>
							<br>
							<br>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="roleid"
										name="roleid" value="${roleid}" readonly>
								</div>
							</div>
							<br>
							<br>
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="createDate"
										name="createDate" value="${createDate}" readonly>
								</div>
							</div>
							<br>
							<br>
							<div class="row">
								<div
									class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-60"></div>
							</div>
						</div>
						<div class="col-md-4 col-sm-4 pull-right">
							<div class="image-container">
								<img src="img/${imagines}"
									alt="Hình ảnh người dùng" width="200" height="200">
							</div>
							<form method="post"
								action="${pageContext.request.contextPath}/update"
								enctype="multipart/form-data">
								Select file to upload: <br /> <input type="file" name="image" />
...
<script>
	function redirectToRegister() {
		...
		window.location.href = "/LaptrinhData/register"; // Thay đổi URL đến trang JSP bạn muốn mở
	}
</script>