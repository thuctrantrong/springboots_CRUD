					...
					<div class="row">
						<div class="col-md-7 col-sm-7">
							<form class="form-horizontal form-without-legend" role="form"
								action="/LaptrinhData/forget" method="post">
								...
								<div class="form-group">
									<label for="password" class="col-lg-4 control-label">Re-enter Password
										<span class="require">*</span>
									</label>
									<div class="col-lg-8">
										<input type="text" class="form-control" id="password"
								...
								<div class="row">
									<div
										...
										<button type="submit" class="btn btn-primary">Accecpt</button>
										<input type="button" class="btn btn-primary" value="Login" onclick="redirectToLogin()">
										<input type="button" class="btn btn-primary" value="Register" onclick="redirectToRegister()">									
									</div>
								</div>
